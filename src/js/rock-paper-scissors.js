...
const text_rock_paper_scissors = document.querySelector('#text_rock_paper_scissors')
const btn_rock_paper_scissors = document.querySelector('.btn_rock_paper_scissors')
...
function selectPlayer(choice) {
    ...
    text_rock_paper_scissors.textContent = 'Тепер натисни кнопку, щоб комп зробив свій вибір';
